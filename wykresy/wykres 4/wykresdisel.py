...
dane_samochody = pd.read_csv(r'E:\wizualizacja\wykres 4/cars_number_olej napędowy.csv')
...
def update_graph(selected_year, selected_indicator):
    ...
    fig = px.scatter(
        ...
        labels={'no_of_cars': 'Liczba samochodów disel', selected_indicator: selected_indicator.upper()}
    )
    return fig
