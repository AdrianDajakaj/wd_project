...
dane_samochody = pd.read_csv(r'E:\wizualizacja\wykres 5/cars_number_gaz (LPG).csv')
...
def update_graph(selected_year, selected_indicator):
    ...
    fig = px.scatter(
        ...
        labels={'no_of_cars': 'Liczba samochodów gaz', selected_indicator: selected_indicator.upper()}
    )
    return fig
