...
dane_samochody = pd.read_csv(r'E:\wizualizacja\wykres 6/cars_number_pozostałe.csv')
...
def update_graph(selected_year, selected_indicator):
    ...
    fig = px.scatter(
        ...
        labels={'no_of_cars': 'Liczba samochodów inne', selected_indicator: selected_indicator.upper()}
    )
    return fig
